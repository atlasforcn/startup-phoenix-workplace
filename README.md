...
- 使用者與痛點：求職者需要可信的友善職場資訊，企業需要把政策承諾轉成可追蹤改善任務。
- 市場與差異：替代方案是職缺網站、匿名評論與顧問稽核；差異在證據、改善紀錄與求職媒合。早期客群從願意改善的企業導入。
- 驗證：記錄場域評估完成、改善任務、員工回饋、職缺轉換、留任與爭議處理等成效指標。
- 商業模式：企業依人數付費訂閱，另有顧問導入與報告報價；收入、訪談成本、審核成本與毛利需驗證。
